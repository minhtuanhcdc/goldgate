  ...
  <app-layout title="User list">
    ...
    <Container>
      ...
      <div class="grid grid-cols-1 mb-2">
        ...
        <div class="flex flex-row border-solid border-1 border-gray-300 py-1 bg-green-200">
          <Button  class="bg-indigo-800 px-2 py-1 float-right cursor-pointer">Import file</Button>
          <input class="w-42 my-1 rounded-sm" type="file" />
      ...
      <Table :headers="headers" :addClass="addClass">
          <tr class="hover:bg-gray-300 " v-for="(bill,i) in billtests.data" :key="i">
            ...
            <td class="border-r-2 text-center">{{bill.phone.phone}}</td>
            <td class="border-r-2" >
