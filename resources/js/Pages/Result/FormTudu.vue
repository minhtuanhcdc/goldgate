<template>
      <div class="py-1 px-6 " id="printMe">
          <div class="grid grid-cols-6 mx-0 py-0">
              <div class="col-span-4 text-center mt-1">
                  <div class="pt-0 py-0 place-items-center flex flex-col">
                        <span class="text-center font-bold text-xl font-sans-Timenew ">PHIẾU XÉT NGHIỆM TẾ BÀO</span>
                        <div>
              ...
              <div class="col-span-2 text-left text-italy text-sm font-bold font-sans-Timenew  mt-2 w-full">
